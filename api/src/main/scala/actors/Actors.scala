...
import play.api.libs.iteratee.Concurrent.broadcast
...
class ChatRoomActor extends Actor {
  ...
  val (broadcaster,pushHere) = Concurrent.broadcast[Project]
...
object ChatRoomActor {
  ...
  case class Quit(channel: Concurrent.broadcast[String]) extends Event
